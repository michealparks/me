...
const create = (listener: AudioListener, file: string, loop = true, volume = 1) => {
...
const createPositional = async (listener: AudioListener, file: string, parent: Object3D, refDistance = 1, loop = true, volume = 1) => {
  const buffer = assets.get(file)
