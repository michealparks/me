...
const Header = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<header class="${"svelte-9otxag"}">
  <section style="${"height: " + escape(height + size) + "px"}" class="${"svelte-9otxag"}">
...
const css$1 = {
	code: "footer.svelte-5fdlr6{display:grid;grid-template-columns:1fr 10fr;grid-template-rows:1fr;grid-column-gap:20px;padding:30px;background-color:#eee}img.svelte-5fdlr6{max-width:180px;border-radius:100%}h2.svelte-5fdlr6{font-family:'Roboto Mono', monospace;font-size:30px}",
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<footer class="${"svelte-5fdlr6"}">
...
const css$2 = {
	code: "body{margin:0;font-family:'Nunito', sans-serif}h1{font-size:5.9vw;font-size:min(50px, 5.9vw)}h2{font-size:3.0vh}p{font-size:2vmin}body .svelte-1ta1a3y{box-sizing:border-box}",
	map: "{\"version\":3,\"file\":\"App.svelte\",\"sources\":[\"App.svelte\"],\"sourcesContent\":[\"\\r\\n<style>\\r\\n  :global(body) {\\r\\n    margin: 0;\\r\\n    font-family: 'Nunito', sans-serif;\\r\\n  }\\r\\n\\r\\n  :global(h1) {\\r\\n    font-size: 5.9vw;\\r\\n    font-size: min(50px, 5.9vw);\\r\\n  }\\r\\n  :global(h2) {\\r\\n    font-size: 3.0vh;\\r\\n  }\\r\\n  :global(p) {\\r\\n    font-size: 2vmin;\\r\\n  }\\r\\n\\r\\n  :global(body) * {\\r\\n    box-sizing: border-box;\\r\\n    }\\r\\n</style>\\r\\n\\r\\n<script>\\r\\n  import Header from './Header.svelte'\\r\\n  import Projects from './Projects.svelte'\\r\\n  import Footer from './Footer.svelte'\\r\\n</script>\\r\\n\\r\\n<main>\\r\\n  <Header />\\r\\n  <Projects />\\r\\n  <Footer />\\r\\n</main>\\r\\n\"],\"names\":[],\"mappings\":\"AAEU,IAAI,AAAE,CAAC,AACb,MAAM,CAAE,CAAC,CACT,WAAW,CAAE,QAAQ,CAAC,CAAC,UAAU,AACnC,CAAC,AAEO,EAAE,AAAE,CAAC,AACX,SAAS,CAAE,KAAK,CAChB,SAAS,CAAE,IAAI,IAAI,CAAC,CAAC,KAAK,CAAC,AAC7B,CAAC,AACO,EAAE,AAAE,CAAC,AACX,SAAS,CAAE,KAAK,AAClB,CAAC,AACO,CAAC,AAAE,CAAC,AACV,SAAS,CAAE,KAAK,AAClB,CAAC,AAEO,IAAI,AAAC,CAAC,eAAE,CAAC,AACf,UAAU,CAAE,UAAU,AACtB,CAAC\"}"
};

const App = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$2);

	return `<main class="${"svelte-1ta1a3y"}">
