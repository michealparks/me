...
function create_if_block(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			a_entity1 = claim_element(a_scene_nodes, "A-ENTITY", { "edge-box": true });
			children(a_entity1).forEach(detach);
			t1 = claim_space(a_scene_nodes);
			a_entity2 = claim_element(a_scene_nodes, "A-ENTITY", { grid: true });
			children(a_entity2).forEach(detach);
			t2 = claim_space(a_scene_nodes);

			a_entity3 = claim_element(a_scene_nodes, "A-ENTITY", {
				"edge-box": true,
				position: true,
				rotation: true
			});
			...
			a_entity4 = claim_element(a_scene_nodes, "A-ENTITY", {
				camera: true,
				id: true,
				position: true,
				rotation: true,
			...
			a_sky = claim_element(a_scene_nodes, "A-SKY", { color: true });
		...
		h() {
			...
			set_custom_element_data(a_entity1, "edge-box", "");
			set_custom_element_data(a_entity2, "grid", "");
			set_custom_element_data(a_entity3, "edge-box", "type: plane; width: 4; height: 4;");
			set_custom_element_data(a_entity3, "position", "0 0 -4");
			set_custom_element_data(a_entity3, "rotation", "-90 0 0");
			set_custom_element_data(a_entity4, "camera", "");
			set_custom_element_data(a_entity4, "id", "camera");
			set_custom_element_data(a_entity4, "position", "0 1.6 0");
			set_custom_element_data(a_entity4, "rotation", "0 0 0");
			set_custom_element_data(a_entity4, "rotation-reader", "");
			set_custom_element_data(a_sky, "color", "#222");
			set_custom_element_data(a_scene, "fog", "type: linear; color: #222; far: 100");
...
function instance$3($$self, $$props, $$invalidate) {
	...
	const register = () => {
		...
		window.AFRAME.registerComponent("grid", {
			init() {
				const { data, el } = this;
				el.setObject3D("mesh", new THREE.GridHelper(5000, 5000, 16777215, 16777215));
			}
		});
...
function create_fragment$6(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*state*/ ctx[0] === "unjammed") return create_if_block$1;
