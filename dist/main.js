...
// (93:4) {#each colors as color (color.hex)}
function create_each_block(key_1, ctx) {
	...
	return {
		...
		h() {
			...
			set_style(bg_circle, "box-shadow", "20px 20px 40px " + /*color*/ ctx[7].hex + ", \r\n             -20px -20px 60px " + /*color*/ ctx[7].hex);
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			if (dirty & /*size, colors, opacity, duration*/ 5) {
...
function create_each_block$1(key_1, ctx) {
	...
	let t1;
	let p;
	let t2_value = /*project*/ ctx[1].summary + "";
	let t2;
	let t3;
	...
	return {
		...
		h() {
			attr(article, "class", "svelte-1e2z65");
			this.first = article;
		},
		m(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			attr(h2, "class", "svelte-1e2z65");
			set_custom_element_data(current_projects, "class", "svelte-1e2z65");
			attr(section, "class", "svelte-1e2z65");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			if (dirty & /*projects*/ 1) {
				...
				each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value, each_1_lookup, current_projects, destroy_block, create_each_block$1, null, get_each_context$1);
			}
		},
		i: noop,
		o: noop,
...
function create_fragment$2(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			var span_nodes = children(span);
			t7 = claim_text(span_nodes, "He has links for you but of course");
			span_nodes.forEach(detach);
